...
Day 12, I combined all my separate scripts into one pipeline — detect.py. Now runs with one command on any two FITS files. Raised MIN_MOVE from 3 to 8 px to kill the alignment errors.